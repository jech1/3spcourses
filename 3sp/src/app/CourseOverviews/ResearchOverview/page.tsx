                ...
                <AccordionItem value="week1">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Chapter 1: Key concepts: reliability, validity, and
                        ethics
                      </li>
                ...
                <AccordionItem value="week2">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Chapter 2: Identifying research problems and objectives
                      </li>
                ...
                <AccordionItem value="week3">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Chapter 3: Understanding experimental and
                        non-experimental designs
                      </li>
                      <li>
                        Chapter 3: Sampling techniques and population analysis
                      </li>
                      <li>
                        Chapter 3: Using surveys, questionnaires, and
                        statistical tools
                      </li>
                ...
                <AccordionItem value="week4">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Chapter 4: Analyzing and interpreting qualitative data
                      </li>
                ...
                <AccordionItem value="week5">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Chapter 5: Integrating qualitative and quantitative
                        approaches
                      </li>
                      <li>
                        Chapter 5: Advantages and challenges of mixed-methods
                        designs
                      </li>
                ...
                <AccordionItem value="week6">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Chapter 6: Choosing the right tools for data collection
                      </li>
                      <li>
                        Chapter 6: Organizing and analyzing data effectively
                      </li>
                      <li>
                        Chapter 6: Interpreting results to address research
                        questions
                      </li>
                ...
                <AccordionItem value="week7">
                  ...
                  <AccordionContent>
                    <ul className="list-disc pl-5 space-y-2">
                      ...
                      <li>
                        Chapter 7: Structuring a research report or presentation
                      </li>
                      <li>
                        Chapter 7: Visualizing data with charts, graphs, and
                        tables
                      </li>
                      <li>
                        Chapter 7: Best practices for sharing findings with
                        different audiences
                      </li>
